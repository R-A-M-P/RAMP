...
$( document ).ready( function () {
	if ( sessionStorage.sessionStorage_intercom_employeee_id ) {
		...
		window.Intercom( "boot", {
			app_id: "uiel53cc",
			user_id: sessionStorage_intercom_employeee_id,
			name: sessionStorage_intercom_employeee_name, // Full name
			email: sessionStorage_intercom_employeee_email, // Email address
			created_at: sessionStorage_intercom_employeee_created_at // Signup date as a Unix timestamp
		} );

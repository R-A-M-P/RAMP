							...
							$( 'code:contains("firstName"):contains("lastName"):contains("occupation"):contains("objectUrn"):contains(' + publicIdentifier + ')' ).each( function () {
								...
								if ( inMemberObject === undefined ) {
									...
									$.getJSON( chrome.extension.getURL( '_locales/' + preferedLanguage + '/messages.json' ), function () {
										console.log( 'success, translation loaded.' );
										...
										RAMP.scrapeExperiences = function () {
											...
											if ( $( '.pv-profile-section__actions-inline' ).find( '.pv-profile-section__see-more-inline.link' ).length ) {
												...
												function startSetInterval() {
													var setIntervalAdd = setInterval( function () {
														if ( setIntervalValue < 25 ) {
															setIntervalValue++;
															if ( $( '.experience-section .pv-profile-section__see-more-inline.link' ).attr( 'aria-expanded' ) === 'false' ) {
															...
															console.log( 'Experience setIntervalValue has reached it\'s limit' );
															clearInterval( setIntervalAdd );
														}
													}, 200 );
													setIntervalAdd;
												...
												// console.warn('Can\'t find "See more positions" button...');
												fetchExperiences();
											}
										}
										...
										function scrapeTheShitOutOfThisProfile() {
											setTimeout( function () {
												...
												setTimeout( function () {
													...
													//
													// }else {
													// 	console.warn('Profilpicture is undefined...');
													// }

											...
											if (initiate_scrape) {
																...
																var setIntervalAdd = setInterval(function () {
																	...
																	if (setIntervalValue < 25) {
																		...
																		if ($('.education-section .pv-profile-section__actions-inline button').attr('aria-expanded') === 'false') {
																			...
																			sectionsScraped++;
																			console.log('Education section scraped. Total sections scraped is now ', sectionsScraped + ' of ' + sectionsToBeScraped);
												...
												RAMP.scrapeSkills = function () {
													...
													if ('.pv-featured-skills-section') {
														...
														setTimeout(function () {
															...
															sectionsScraped++;
															console.log('Skills section scraped. Total sections scraped is now ', sectionsScraped + ' of ' + sectionsToBeScraped);
												...
												RAMP.scrapeSummary = function () {
													...
													if ('.pv-top-card-section__summary') {
														...
														setTimeout(function () {
															...
															sectionsScraped++;
															console.log('Summary section scraped. Total sections scraped is now ', sectionsScraped + ' of ' + sectionsToBeScraped);
												...
												RAMP.scrapeContactInfo = function () {
													...
													if ($('.pv-contact-info__contact-type.ci-vanity-url')) {
														...
														sectionsScraped++;
														console.log('Contact and Personal Info section scraped. Total sections scraped is now ', sectionsScraped + ' of ' + sectionsToBeScraped);
												...
												swal.queue([{
													...
													allowOutsideClick: false,
													allowEscapeKey: false,
													html: 'Fetching <strong>Contact and Personal Info</strong> for ' + candidateFullName + '.',
													...
													preConfirm: function () {
														...
														return new Promise(function (resolve) {
															...
															function swalLoaderSettings() {

																sectionNamesRotateSpeed = sectionNamesRotateTime / sectionsToBeScraped;
																console.log('sectionNamesRotateSpeed', sectionNamesRotateSpeed);

																console.log('sectionNamesToBeScraped: ', sectionNamesToBeScraped);
																console.log('sectionNamesRotateTime: ', sectionNamesRotateTime);

																$('.swal2-modal.swal2-show .swal2-content').html('Fetching <strong><span id="js-rotating">' + sectionNamesToBeScraped + '</span></strong> for ' + candidateFullName + '.');

																$('.swal2-modal.swal2-show .swal2-content').fadeIn();

																$("#js-rotating").Morphext({
																	animation: "bounceIn",
																	separator: ",",
																	speed: sectionNamesRotateSpeed
																});
															...
															function startSetInterval() {
																...
																var setIntervalAdd = setInterval(function () {
																	...
																	if (sectionsToBeScraped == sectionsScraped) {

																		console.info(sectionsScraped + ' out of ' + sectionsToBeScraped + ' sections scraped for info');
